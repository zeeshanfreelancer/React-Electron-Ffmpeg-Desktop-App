        ...
        <div className="form-section">
          <div className="section-content">
            ...
            <div className="form-group">
              <label>Social Media Preset</label>
              <select
                value={effectSocialPreset}
                onChange={(e) => handleEffectSocialPreset(e.target.value)}
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setEffectBackgroundMusic(prev => ({
                      ...prev,
                      volume: parseFloat(e.target.value)
                    }))}
                    disabled={isEffectGenerating}
            ...
            {isEffectGenerating && (
              <div className="progress-section">
                <div className="progress-bar-container">
                  <div
                    className="progress-bar-fill"
                    style={{ width: `${effectProgress}%` }}
                  >
                    <span className="progress-text">{effectProgress}%</span>
                  </div>
                </div>
                {effectProgressMessage && (
                  <p className="progress-message">{effectProgressMessage}</p>
                )}
                <div className="cancel-button-container">
